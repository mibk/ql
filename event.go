...
// EventKv receives a notification when various events occur along with optional
// key/value data.
...
// EventErrKv receives a notification of an error if one occurs along with optional
// key/value data.
